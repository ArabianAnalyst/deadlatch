...
date: "2026-07-09"
description: "Which part of AI agents that spend money is solved, which part is only bounded, and which part nobody has solved yet."
---
...
![The Purse broker holds the payment credential in a separate process the agent cannot reach. The agent proposes a spend, the broker binds it to an intent and checks policy, the key is used on the agent's behalf, and every decision is written to a tamper-evident log.](/log/broker-architecture.svg)
...
- Dignum, V., and F. Dignum. "Agentifying Agentic AI." arXiv:2511.17332, 2025.
- Purse, the enforcement layer this paper is grounded in. `npm i @olurabian/purse`, threat model and deployment contract in the [project repository](https://github.com/ArabianAnalyst/purse).
