...
The deadlatch.dev site, including the in-browser audit and the live demo, published from this repository. The versions that receive fixes are the latest release and the commit on the default branch.
...
The stack the site describes is held to the threat model in the Purse README, https://github.com/ArabianAnalyst/purse#threat-model.
